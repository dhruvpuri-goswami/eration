...
if (isset($_SESSION['rationcard_no'])) {
    ...
    <body>
        <nav class="sidebar close">
            <header>
                <div id="brandLogoSecWrap" class="image-text">
                    <span  class="image">
                                        ...
                                        <form method="post" action="">
                                            <div class="card w3-margin-top w3-round-large">
                                                ...
                                                if ($row['stock_name'] != "Oil") {
                                                    ?>
                                                    <p class="price">
                                                        <?php echo "₹ " . $row['stock_price']; ?>/KG
                                                    </p>
                                                    <?php
                                                } else { ?>
                                                    <p class="price">
                                                        <?php echo "₹ " . $row['stock_price']; ?>/Litres
                                                    </p>
                                                    <?php
                                                }
                                                ?>
        ...
        <script>
            ...
            let brandLogo = document.getElementById("brandLogoSecWrap");
            console.log(brandLogo, sidebar.classList.contains("close"))
            if(sidebar.classList.contains("close")){
                brandLogo.classList.remove("unshow-image");
            }else{
                brandLogo.classList.add("unshow-image");
            }

    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      <header class="mb-4 flex items-center justify-between py-4 md:py-5">
        ...
        <div class="flex items-center">
          ...
          <sub class="mt-1">
            <img src="./images/quote.png" alt="" width="120px">
          </sub>
        </div>
        <!-- logo - end -->
      ...
      <section
        class="min-h-96 relative flex flex-1 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100 py-16 shadow-lg md:py-20 xl:py-35">
        <!-- image - start -->
        <img src="./images/landingpagebg.jpg" loading="lazy" alt="Photo by Fakurian Design"
          class="absolute inset-0 opacity-70 h-full w-full object-cover object-center" />
        <!-- image - end -->
        ...
        <div class="relative flex flex-col items-center p-4 sm:max-w-xl">
          <p class="mb-4 text-center text-lg text-Zinc-950 sm:text-2xl md:mb-8">Revolutionary E-Ration Digital Platform
            solution.</p>
          <h1 class="mb-8 text-center text-4xl font-bold text-gray-50 sm:text-5xl md:mb-12 md:text-6xl">Very proud to
            introduce India's first E-Ration Platform.</h1>
          ...
          <div class="flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center">
            ...
            <a href="#servicessSection"
              class="inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">View
              Features</a>
          </div>
        </div>
        <!-- text end -->
